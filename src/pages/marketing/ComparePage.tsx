...
const competitors = [
  {
    ...
    features: {
      ...
      'Moisture tracking with auto calculations': true,
      'Photo documentation': true,
      'Photo annotations': true,
      'Built-in floor plans (mud maps)': true,
      'Equipment tracking': true,
      'Work logging': true,
      'Damage assessments': true,
      'One-click PDF reports': true,
      'Insurance-compliant format': true,
      'Custom company branding': true,
      'Thermal readings section': true,
      'Digital signatures': true,
      'Comprehensive report template': true,
      'Easy learning curve': true,
      'Offline capability': true,
      'Team collaboration': true,
      'Quick onboarding (< 1 hour)': true,
      'Free tier available': true,
      'Transparent pricing': true,
      'No long-term contracts': true,
      'Pay-as-you-grow model': true,
    },
  },
  {
    name: 'Encircle',
    features: {
      ...
      'Photo documentation': true,
      'Photo annotations': true,
      'Built-in floor plans (mud maps)': false,
      'Equipment tracking': true,
      'Work logging': true,
      'Damage assessments': true,
      'One-click PDF reports': true,
      ...
      'Digital signatures': true,
      'Comprehensive report template': true,
      'Easy learning curve': 'partial',
      'Offline capability': true,
      'Team collaboration': true,
      'Quick onboarding (< 1 hour)': false,
      'Free tier available': false,
      'Transparent pricing': false,
      'No long-term contracts': false,
      'Pay-as-you-grow model': false,
    },
  },
  {
    name: 'Xactimate',
    features: {
      ...
      'Moisture tracking with auto calculations': 'partial',
      'Photo documentation': true,
      'Photo annotations': 'partial',
      'Built-in floor plans (mud maps)': true,
      'Equipment tracking': 'partial',
      'Work logging': false,
      'Damage assessments': true,
      'One-click PDF reports': 'partial',
      'Insurance-compliant format': true,
      'Custom company branding': true,
      'Thermal readings section': false,
      'Digital signatures': true,
      'Comprehensive report template': 'partial',
  ...
  },
  {
    ...
    features: {
      'Mobile-first design': true,
      'Moisture tracking with auto calculations': false,
      'Photo documentation': true,
      'Photo annotations': 'partial',
      'Built-in floor plans (mud maps)': false,
      'Equipment tracking': 'partial',
      'Work logging': true,
      'Damage assessments': 'partial',
      'One-click PDF reports': true,
      'Insurance-compliant format': 'partial',
      'Custom company branding': true,
      'Thermal readings section': false,
      'Digital signatures': true,
      'Comprehensive report template': false,
      'Easy learning curve': true,
      'Offline capability': 'partial',
      'Team collaboration': true,
      'Quick onboarding (< 1 hour)': true,
  ...
  },
  {
    ...
    features: {
      ...
      'Photo annotations': false,
      'Built-in floor plans (mud maps)': false,
      'Equipment tracking': 'partial',
      'Work logging': 'partial',
      'Damage assessments': 'partial',
      'One-click PDF reports': false,
      'Insurance-compliant format': false,
      'Custom company branding': 'partial',
      'Thermal readings section': false,
...
const competitorDetails = [
  {
    name: 'Encircle',
    description:
      'Encircle is the industry standard for enterprise restoration companies, known for comprehensive documentation and insurance compliance. However, their enterprise-focused approach means complex pricing, lengthy onboarding, and features many small-to-mid teams never use.',
    advantages: [
      ...
      'Faster onboarding—start documenting in minutes, not days',
  ...
  },
  {
    name: 'Xactimate',
    description:
      'Xactimate is the gold standard for restoration estimating and insurance pricing. While essential for estimates, it\'s not designed for field documentation—technicians need additional tools for moisture tracking, work logs, and comprehensive drying reports.',
    advantages: [
  ...
  },
  {
    name: 'DASH',
    description:
      'DASH by JobProgress is a general contractor management tool that handles job tracking, scheduling, and customer management. While versatile, it lacks the restoration-specific features like moisture tracking, psychrometric calculations, and insurance-compliant drying logs.',
    advantages: [
      ...
      'Industry-standard 3-day drying log format',
    ],
...
const differentiators = [
  {
    icon: Zap,
    title: 'Purpose-Built for Restoration',
    description: 'Not a generic contractor tool—every feature designed for water damage documentation.',
  },
  {
    icon: Smartphone,
    title: 'Field-First Design',
    description: 'Built for iPad and mobile use in the field, not desktop-only office software.',
  },
  {
    icon: Clock,
    title: 'Instant Reports',
    description: 'Generate insurance-ready PDF reports in one click, not hours of formatting.',
  },
  {
    icon: DollarSign,
    title: 'Transparent Pricing',
    description: 'Know exactly what you\'ll pay. No surprise fees or enterprise sales calls.',
  },
  {
    icon: Shield,
    title: 'Insurance Compliant',
    description: 'Reports meet insurance documentation standards right out of the box.',
  },
  {
    icon: Users,
    title: 'Free to Start',
    description: 'Try everything with our free tier. No credit card, no commitment.',
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              See why restoration professionals choose FloodEx for faster documentation,
              better reports, and simpler pricing.
            </p>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              See exactly how FloodEx stacks up against each competitor.
            </p>
          </div>
