        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Start free, upgrade when you're ready. Pay only for what you use with our 
              flexible soft-limit system.
            </p>
          </div>
                  ...
                  {sortedTiers.map((tier) => (
                    ...
                    >
                      ...
                      {tier.name.toLowerCase() === 'pro' && (
                        <span className="block text-xs text-primary font-normal">Most Popular</span>
                      )}
                    </th>
                  ))}
                </tr>
      ...
      <section className="py-20 lg:py-32 bg-card">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Soft Limits, No Surprises
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Exceed your limits? No problem. We use soft limits so your work never stops. 
              Overages are billed at transparent rates at the end of each billing period.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Everything you need to know about FloodEx pricing.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-primary/10 to-transparent">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
            For large organizations with custom needs, we offer tailored plans with 
