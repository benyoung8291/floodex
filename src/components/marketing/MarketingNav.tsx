...
export function MarketingNav() {
  ...
  return (
    <nav className="mx-4 md:mx-8 my-2 flex items-center justify-between px-3 py-2 bg-white/80 backdrop-blur-xl rounded-full border border-border/60 shadow-sm">
